      ...
      <div className='flex flex-col-reverse sm:flex-row h-full relative max-w-7xl mx-auto items-center gap-0'>
        ...
        >
          <div className='max-w-2xl'>
            {/* Small greeting text */}
            <motion.p
              className='text-gray-500 text-center sm:text-start dark:text-gray-400 mb-4 text-3xl md:text-4xl'
            ...
            {/* Main heading */}
            <motion.h1
              className='text-2xl text-center md:text-left md:text-6xl font-bold bg-gradient-to-r from-gray-900 via-purple-900 to-gray-900 dark:from-white dark:via-purple-300 dark:to-white bg-clip-text text-transparent mb-6'
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
